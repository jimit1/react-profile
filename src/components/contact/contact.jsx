...
class Contact extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    let API_KEY = "user_55MYdNCXyPmEjWQ7c6PVs";

    // YOUR EMAIL.JS TEMPLATE ID
    let TEMPLATE_ID = "template_89N9Noin";
    ...
    return (
      <div id="contact">
        ...
        <div className="wrapper">
          ...
          <p className="font12">
            Reach out for some brain-storming on Account-based Marketing
            Strategies, Sales and Sales Development, Entrepreneurship,<br></br>
            Organic Chemistry (specifically Pd-catalyzed Amination for SN2
            Reactions)
          </p>
